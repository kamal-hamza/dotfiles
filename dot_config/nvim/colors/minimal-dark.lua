...
local c = {
    bg = "#101010", fg = "#b0b0b0",
    cursorline = "#272727", linenr = "#474747", cursorlinenr = "#b0b0b0",
    visual = "#458ee6", search_active = "#d9ba73", border = "#272727",
    comment = { fg = "#50585d", italic = true },
    keyword = { fg = "#777777", italic = true },
    ...
    variable = { fg = "#b0b0b0" },
    operator = { fg = "#777777" },
    punctuation = { fg = "#b0b0b0" },
    special = { fg = "#ffffff" },
    error = "#ff7676", warning = "#d9ba73", info = "#8ebeec", hint = "#474747",
    vcs_added = "#86cd82", vcs_modified = "#d9ba73", vcs_deleted = "#ff7676",
}
