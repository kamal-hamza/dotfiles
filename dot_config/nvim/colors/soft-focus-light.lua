...
vim.g.colors_name = "soft_focus_light"

local c = {
    bg = "#ffffff", fg = "#000000",
    cursorline = "#e0e0e0", linenr = "#999999", cursorlinenr = "#000000",
    visual = "#d6e4f2", search_active = "#d12846", border = "#e0e0e0",
    comment = { fg = "#666666", italic = true },
    keyword = { fg = "#d12846", italic = true },
    func = { fg = "#256eb5", bold = true },
    string = { fg = "#3a853a" },
    constant = { fg = "#a67c1e" },
    type = { fg = "#a67c1e" },
    variable = { fg = "#000000" },
    ...
    special = { fg = "#a84a65" },
    error = "#d12846", warning = "#ba681c", info = "#1c73b4", hint = "#999999",
    vcs_added = "#3a853a", vcs_modified = "#a67c1e", vcs_deleted = "#d12846",
}
