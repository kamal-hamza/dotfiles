return {
  ...
  config = function(_, opts)
    ...
    set_hl(0, 'BlinkCmpMenu', { bg = colors.bg_elevated, fg = colors.fg })
    set_hl(0, 'BlinkCmpMenuBorder', { bg = colors.bg_elevated, fg = colors.bg_elevated })
    set_hl(0, 'BlinkCmpMenuSelection', { bg = colors.bg_alt, fg = colors.fg, bold = true })
    
    -- Documentation window
    set_hl(0, 'BlinkCmpDoc', { bg = colors.bg, fg = colors.fg })
    set_hl(0, 'BlinkCmpDocBorder', { bg = colors.bg, fg = colors.blue })
    set_hl(0, 'BlinkCmpDocCursorLine', { bg = colors.bg_elevated })
    
    -- Signature help
    set_hl(0, 'BlinkCmpSignatureHelp', { bg = colors.bg, fg = colors.fg })
    set_hl(0, 'BlinkCmpSignatureHelpBorder', { bg = colors.bg, fg = colors.blue })
    set_hl(0, 'BlinkCmpSignatureHelpActiveParameter', { fg = colors.orange, bold = true })
    
    -- Labels and text
    set_hl(0, 'BlinkCmpLabel', { fg = colors.fg })
    set_hl(0, 'BlinkCmpLabelDeprecated', { fg = colors.fg_dim, strikethrough = true })
    set_hl(0, 'BlinkCmpLabelMatch', { fg = colors.blue, bold = true })
